...
object `package` extends MillBuildRootModule {
  ...
  def assemblyModuleSource = Task.Source(Task.workspace / "scalalib/src/mill/scalalib/AssemblyModule.scala")
  def allSourceFiles = super.allSourceFiles() ++ Seq(assemblyModuleSource())
}
