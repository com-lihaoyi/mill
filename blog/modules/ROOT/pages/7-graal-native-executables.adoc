...
* xref:mill:ROOT:javalib/publishing.adoc#_building_native_image_with_graal_vm[]
...
<h1>hello-world</h1>
./out/foo/assembly.dest/out.jar --text hello-world  0.35s user 0.04s system 165% cpu 0.235 total
```
...
<h1>hello-world</h1>
./out/foo/nativeImage.dest/native-executable --text hello-world  0.04s user 0.01s system 87% cpu 0.062 total
```
...
https://github.com/com-lihaoyi/mill/blob/b16c589a93e2e6d4e5361246d842409fd8e71158/.github/workflows/publish-artifacts.yml#L79-L95[matrix of Github actions jobs]
