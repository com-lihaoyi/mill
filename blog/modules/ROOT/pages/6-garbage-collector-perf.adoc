...
This is a small Java program that starts off allocating a bunch of `Object[]` arrays,
and then in a loop continuously allocates more `Object[]`s and over-writes the references
to older ones. This is a bit of a synthetic benchmark, and much less complex than a real-world
