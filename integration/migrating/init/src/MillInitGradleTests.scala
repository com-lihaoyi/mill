    ...
    test {
      ...
      integrationTest(url)(
        testMillInit(
          ...
          ```
           */
          initCommand = defaultInitCommandWithoutMerge ++ Seq("--jvm-id", "17"),
          expectedAllSourceFileNums = Map(
            "moshi-adapters.test.allSourceFiles" -> 3,
            "kotlin.tests.codegen-only.test.allSourceFiles" -> 0,
            "moshi-kotlin.test.allSourceFiles" -> 0,
            "moshi-adapters.japicmp.allSourceFiles" -> 0,
            "moshi.records-tests.allSourceFiles" -> 0,
            "moshi-kotlin.allSourceFiles" -> 0,
            "moshi-kotlin-codegen.allSourceFiles" -> 0,
            "kotlin.allSourceFiles" -> 0,
            // no Java sources
            "kotlin.tests.extra-moshi-test-module.allSourceFiles" -> 0,
            "moshi.records-tests.test.allSourceFiles" -> 1,
            "moshi.allSourceFiles" -> 31,
            "kotlin.tests.allSourceFiles" -> 0,
            "kotlin.tests.test.allSourceFiles" -> 0,
            "moshi-kotlin-codegen.test.allSourceFiles" -> 1,
            // no sources (test only modules)
            "kotlin.tests.codegen-only.allSourceFiles" -> 0,
            "moshi-adapters.allSourceFiles" -> 5,
            "moshi.japicmp.allSourceFiles" -> 0,
            "moshi.test.allSourceFiles" -> 26,
            "examples.allSourceFiles" -> 25
          ),
          expectedCompileTaskResults = Some(SplitTaskResults(
            successful = SortedSet(
              "examples.compile",
