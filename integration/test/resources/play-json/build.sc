...
val ScalaVersions = Seq("2.10.7", "2.11.12", "2.12.5", "2.13.0-M3")
...
val testModules = Seq(
  playJsonJvm("2.12.5").`test-scalatest`,
  playJsonJvm("2.12.5").`test-specs2`,
  playJsonJs("2.12.5").test,
  playJoda("2.12.5").test
)
