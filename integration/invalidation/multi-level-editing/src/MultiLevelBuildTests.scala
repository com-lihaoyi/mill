...
object MultiLevelBuildTests extends IntegrationTestSuite {
  val tests: Tests = Tests {
     ...
     */
    def checkChangedClassloaders(tester: IntegrationTester, expectedChanged0: java.lang.Boolean*) = {
    ...
    test("validEdits") - integrationTest { tester => import tester._
      runAssertSuccess(tester, "<h1>hello</h1><p>world</p><p>0.8.2</p>!")
      checkWatchedFiles(tester,fooPaths(tester), buildPaths(tester), buildPaths2(tester), buildPaths3(tester))
    ...
    test("parseErrorEdits") - integrationTest { tester => import tester._
    ...
    test("compileErrorEdits") - integrationTest { tester => import tester._
    ...
    test("runtimeErrorEdits") - integrationTest { tester => import tester._
      val runErrorSnippet = """{
