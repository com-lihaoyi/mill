    ...
    test("noticker") - integrationTest { tester =>
      ...
      assertGoldenLiteral(
        ...
        List(
          ...
          "done compiling",
          "compiling 1 Scala source and 1 Java source to /Users/lihaoyi/Github/mill/out/integration/feature/full-run-logs/packaged/daemon/testForked.dest/worker-2/sandbox/run-1/out/compile.dest/classes ...",
          "done compiling"
        )
      )
    }
    ...
    test("ticker") - integrationTest { tester =>
      ...
      assertGoldenLiteral(
        ...
        List(
          ...
          "<digits>] compile",
          "<digits>] compiling 1 Scala source and 1 Java source to /Users/lihaoyi/Github/mill/out/integration/feature/full-run-logs/packaged/daemon/testForked.dest/worker-2/sandbox/run-2/out/compile.dest/classes ...",
