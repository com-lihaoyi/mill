      ...
      retry(3) {
        ...
        assertGoldenLiteral(
          ...
          List(
            ...
            "(B)<digits>](X) (G)ABCDEFGHIJABCDEFGHIJABCDEFGHIJABCDEFGHIJABCDEFGHIJ_(B)<digits>](X) (G)19(X)",
            ...
            "(B)<digits>](X) (C)ABCDEFGHIJABCDEFGHIJABCDEFGHIJABCDEFGHI(B)<digits>](X) (C)JABCDEFGHIJ_38(X)",
            ...
            "(B)<digits>](X) (Y)ABCDEFGHIJABCDEFGHIJABCDEFG(B)<digits>](X) (Y)HIJABCDEFGHIJABCDEFGHIJ_57(X)",
