...
object MillPluginClasspathTest extends UtestIntegrationTestSuite
  ...
  val embeddedModules: Seq[(String, String)] = Seq(
    ("com.lihaoyi", "mill-libs-client"),
    ("com.lihaoyi", "mill-libs-api_2.13"),
    ("com.lihaoyi", "mill-libs-util_2.13"),
    ("com.lihaoyi", "mill-libs-codesig_2.13"),
    ("com.lihaoyi", "mill-bsp_2.13"),
    ("com.lihaoyi", "mill-libs-scalanativelib-worker-api_2.13"),
    ("com.lihaoyi", "mill-libs-testrunner-entrypoint"),
    ("com.lihaoyi", "mill-libs-scalalib-api_2.13"),
    ("com.lihaoyi", "mill-testrunner_2.13"),
    ("com.lihaoyi", "mill-libs-define_2.13"),
    ("com.lihaoyi", "mill-libs-resolve_2.13"),
    ("com.lihaoyi", "mill-libs-eval_2.13"),
    ("com.lihaoyi", "mill-main_2.13"),
    ("com.lihaoyi", "mill-scalalib_2.13"),
    ("com.lihaoyi", "mill-scalanativelib_2.13"),
    ("com.lihaoyi", "mill-libs-scalajslib-worker-api_2.13"),
