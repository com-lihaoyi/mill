...
object MetaBuildTests extends MetaBuildTests(fork = true, clientServer = true)
object MetaMetaBuildTests extends MetaMetaBuildTests(fork = true, clientServer = true)
