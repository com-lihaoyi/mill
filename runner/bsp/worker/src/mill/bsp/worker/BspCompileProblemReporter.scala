...
import mill.api.daemonapi.internal.{CompileProblemReporter, Problem}
    ...
    sourceFile match {
      case None =>
        ...
        val messagesType = problem.severity match {
          case mill.api.daemonapi.internal.Error => MessageType.ERROR
          case mill.api.daemonapi.internal.Warn => MessageType.WARNING
          case mill.api.daemonapi.internal.Info => MessageType.INFO
        }
    ...
    new bsp.Diagnostic(new bsp.Range(start, end), problem.message).tap { d =>
      ...
      d.setSeverity(
        problem.severity match {
          case mill.api.daemonapi.internal.Info => bsp.DiagnosticSeverity.INFORMATION
          case mill.api.daemonapi.internal.Error => bsp.DiagnosticSeverity.ERROR
          case mill.api.daemonapi.internal.Warn => bsp.DiagnosticSeverity.WARNING
        }
      )
