...
object Parser {
  def prefix[$: P] = P("hello" | "goodbye").!.map(new Word(_))

  def suffix[$: P] = P("world" | "seattle").!.map(new Word(_))
...
/* expected-direct-call-graph
{
    ...
    "hello.Parser$#rec$1(fastparse.ParsingRun,int,fastparse.ParsingRun,fastparse.Implicits$Repeater,java.lang.Object,int,int,boolean,boolean,fastparse.internal.Msgs,fastparse.internal.Msgs)fastparse.ParsingRun": [
