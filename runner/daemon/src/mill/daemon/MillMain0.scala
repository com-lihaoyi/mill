...
import mill.api.daemonapi.internal.bsp.{BspServerHandle, BspServerResult}
import mill.api.daemonapi.internal.{CompileProblemReporter, EvaluatorApi, internal}
...
import mill.api
import mill.api.daemonapi.internal.bsp.BspServerResult
...
object MillMain0 {
  ...
  def main0(
    ...
    mill.api.daemonapi.internal.MillScalaParser.current.withValue(MillScalaParserImpl) {
