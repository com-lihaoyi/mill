...
[source,scala]
----
def ivyDeps = Seq(ivy"com.google.guava:guava:3.3.1-jre")
----
|===
...
[source,scala]
----
def ivyDeps = Seq(ivy"com.lihaoyi::scalatags:0.12.0")
----
|===
...
* Similarly, you may need to us `Task.workspace` or `WorkspaceRoot.workspaceRoot`
