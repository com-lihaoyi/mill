...
The generated output can be configured using command line options. To list available options, run:
[source,sh]
----
./mill init --help
----
TIP: The `init` command can be run multiple times with any combination of options.
