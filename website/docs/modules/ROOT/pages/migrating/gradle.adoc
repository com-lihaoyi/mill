...
* Mill does not add `compileJvmDeps` dependencies to the transitive dependencies of the nested
test module; specify the dependencies again, in `jvmDeps` or `runJvmDeps`.
