...
* Mill does not add `compileLibraryDeps` dependencies to the transitive dependencies of the nested
test module; specify the dependencies again, in `libraryDeps` or `runLibraryDeps`.
