...
```scala
./mill -i Foo.scala:repl
```


== Script moduleDeps

include::partial$example/scalalib/script/7-script-deps.adoc[]

== Relative and Absolute Script moduleDeps

include::partial$example/scalalib/script/8-relative-deps.adoc[]


== Project `moduleDeps`

include::partial$example/scalalib/script/9-programmable-module-deps.adoc[]


== Custom Script Module Classes

include::partial$example/scalalib/script/10-custom-class.adoc[]


== Script Resources

include::partial$example/scalalib/script/11-resources.adoc[]


== Custom JVM Versions

include::partial$example/scalalib/script/12-jvm-version.adoc[]

== Bundled Libraries

include::partial$example/scalalib/script/13-raw.adoc[]
