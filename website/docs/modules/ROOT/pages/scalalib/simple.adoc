...
include::partial$example/scalalib/simple/1-common-config.adoc[]

== SBT Compatibility Modules

include::partial$example/scalalib/simple/2-compat-modules.adoc[]

== Packaging and Publishing Simple Modules

include::partial$example/scalalib/simple/3-publish.adoc[]
...
include::partial$example/scalalib/simple/5-mixed-module-deps.adoc[]

== Single-File Scripts

include::partial$example/scalalib/simple/6-script.adoc[]
