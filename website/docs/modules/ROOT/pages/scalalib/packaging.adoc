...
include::partial$example/scalalib/packaging/2-native-image-libs.adoc[]


== Building Executable Assemblies

include::partial$example/scalalib/packaging/3-assembly-config.adoc[]

== Building `Repackage` Assemblies

include::partial$example/scalalib/packaging/4-repackage-config.adoc[]
