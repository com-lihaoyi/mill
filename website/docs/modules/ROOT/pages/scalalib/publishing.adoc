...
== Building Actually Portable Executable (APE) Assemblies

Mill supports building a single executable assembly that runs on multiple platforms. For more details, see:

* xref:javalib/publishing.adoc#_building_actually_portable_executable_ape_assemblies[Building Actually Portable Executable (APE) Assemblies]
...
include::partial$example/scalalib/publishing/8-native-image-libs.adoc[]
