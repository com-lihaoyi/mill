...
include::partial$example/scalalib/module/1-basic-config.adoc[]

=== Scala Compiler Plugins

include::partial$example/scalalib/module/2-scala-compiler-plugins.adoc[]

=== Scaladoc Config

include::partial$example/scalalib/module/3-docjar.adoc[]
...
include::partial$example/scalalib/module/6-generated-sources.adoc[]
