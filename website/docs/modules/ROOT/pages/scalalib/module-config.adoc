...
include::partial$example/scalalib/module/16-scala-nightlies.adoc[]

== Custom Module Traits

include::partial$example/scalalib/module/17-custom-trait.adoc[]

== Programmable `moduleDeps`

include::partial$example/scalalib/module/18-programmable-module-deps.adoc[]