...
configured a `def jvmId` on individual modules. Mill manages these JVMs automatically for
...
include::partial$example/fundamentals/javahome/2-custom-builtin-jvm.adoc[]

== Setting the JVM Version of a JavaModule

include::partial$example/fundamentals/javahome/3-custom-module-jvms.adoc[]
