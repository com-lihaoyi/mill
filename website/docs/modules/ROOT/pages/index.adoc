...
syntax highlighted command-line output and
xref:cli/installation-ide.adoc#_bashzsh_tab_completion[terminal tab-completion] mean developers can
easily navigate their builds and resolve issues.
