...
* *Ergonomics*: Mill's xref:javalib/intro.adoc#_declarative_module_config[declarative config files]
are concise and easy to read, its xref:javalib/intro.adoc#_programmable_module_config[programmable config files]
