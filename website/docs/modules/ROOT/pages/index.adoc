...
* Mill's rich featureset supports everything from xref:javalib/intro.adoc#_single_file_scripts[single-files] to
xref:large/large.adoc[large projects] with
xref:comparisons/why-mill.adoc#_rich_builtins[less need for plugins]
