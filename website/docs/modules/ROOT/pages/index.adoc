...
* Mill's featureset supports everything from xref:javalib/config.adoc#_single_file_scripts[single-files] to
xref:large/large.adoc[large projects] needing
...
* https://www.youtube.com/watch?v=tNsz_dGCsVs[Video: Simpler Build Tools with Functional and Object Oriented Programming], Scala Workshop 13 October 2025
