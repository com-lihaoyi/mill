...
xref:cli/installation-ide.adoc#_bashzsh_tab_completion[terminal tab-completion] to streamline
usage and syntax highlighted command-line output and error messages so
developers can easily read, understand, and resolve issues.
