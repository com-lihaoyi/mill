...
* *Ergonomic*: Mill provides colored and formatted command-line output and syntax
highlights the code in error messages, making it easier for the developer to quickly
read, understand, and resolve issues.
