...
your build, stripping away the reams of boilerplate and endless complexity in traditional
JVM build tools to make your configuration easy to write, easy to read, and easy to understand
...
write custom code to extend your build system. The table below links to the relevant part of the
documentation and examples for each feature or tool:
