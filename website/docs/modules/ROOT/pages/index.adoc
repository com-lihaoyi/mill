...
Mill supports most common JVM development workflows built in: testing, publishing, packaging,
managing JVM installations, and so on. This removes the need to fiddle with third-party plugins
or install separate tools such as https://sdkman.io/[SdkMan] or https://www.jenv.be/[Jenv]
just to get your project up and running. The example build file below shows
...
jvmVersion: 11 # Pin a specific JVM version, downloaded and cached automatically
...
Beyond this example, the table below links to the relevant part of the
