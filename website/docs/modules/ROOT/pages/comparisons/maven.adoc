...
object common extends NettyModule {
  ...
  def generatedSources = Task {
    ...
    context.put("collection.template.dir", s"${mill.define.BuildCtx.workspaceRoot}/common/src/main/templates")
    context.put("collection.template.test.dir", s"${mill.define.BuildCtx.workspaceRoot}/common/src/test/templates")
