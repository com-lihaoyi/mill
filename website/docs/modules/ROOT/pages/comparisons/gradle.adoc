...
Mill defaults to a xref:javalib/intro.adoc#_declarative_modules[declarative configuration syntax],
but when you do need to extend your build with custom logic Mill's
xref:javalib/intro.adoc#_programmable_modules[programmable configuration syntax]
