...
impose, resulting in edit-compile-run workflows that are 3-6x faster than those of other
Java build tools.
...
For more details on these benchmarks, see xref:#_mill_vs_maven_in_depth[]
...
For more details on these benchmarks, see xref:#_mill_vs_gradle_in_depth[]
