...
include::partial$example/javalib/publishing/1-publishing-yaml.adoc[]

== VCS Version Publishing

include::partial$example/javalib/publishing/2-vcs-version.adoc[]

== Programmatic Publishing Configuration

include::partial$example/javalib/publishing/3-publishing.adoc[]
