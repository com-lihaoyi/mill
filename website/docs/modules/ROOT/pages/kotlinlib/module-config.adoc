...
include::partial$example/kotlinlib/module/5-compilation-execution-flags.adoc[]
...
include::partial$example/kotlinlib/module/16-custom-trait.adoc[]

== Programmable `moduleDeps`

include::partial$example/kotlinlib/module/17-programmable-module-deps.adoc[]
