...
include::partial$example/kotlinlib/config/2-compat-modules.adoc[]
...
include::partial$example/kotlinlib/config/4-custom-class.adoc[]

== Depending on Programmatic Modules from Simple Modules

include::partial$example/kotlinlib/config/5-mixed-module-deps.adoc[]

== Single-File Scripts

include::partial$example/kotlinlib/config/6-script.adoc[]
