...
include::partial$example/kotlinlib/basic/4-programmatic.adoc[]

== Custom Build Logic

include::partial$example/kotlinlib/basic/5-custom-build-logic.adoc[]

== Programmatic Multi-Module Project

include::partial$example/kotlinlib/basic/6-multi-module.adoc[]

== Programmatic Compatibility Modules

include::partial$example/kotlinlib/basic/7-programmatic-compat.adoc[]

== Realistic Java Example Project

include::partial$example/kotlinlib/basic/8-realistic.adoc[]
