...
include::partial$example/kotlinlib/simple/1-common-config.adoc[]

== Maven Compatibility Modules

include::partial$example/kotlinlib/simple/2-compat-modules.adoc[]

== Packaging and Publishing Simple Modules

include::partial$example/kotlinlib/simple/3-publish.adoc[]
...
include::partial$example/kotlinlib/simple/5-mixed-module-deps.adoc[]

== Single-File Scripts

include::partial$example/kotlinlib/simple/6-script.adoc[]
