...
For all defined options and tasks, please see the official
https://github.com/OpenAPITools/openapi-generator/tree/master/modules/openapi-generator-mill-plugin[documentation].
