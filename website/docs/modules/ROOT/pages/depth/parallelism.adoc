...
IDE-triggered xref:cli/installation-ide.adoc[BSP] request) can run their non-conflicting tasks
...
marked xref:fundamentals/tasks.adoc#_globally_exclusive_commands[globally exclusive]: they take
