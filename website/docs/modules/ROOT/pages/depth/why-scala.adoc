...
dynamic classloading. Features like xref:extending/import-mvn-plugins.adoc[import $ivy],
...
as part of the build using xref:extending/import-mvn-plugins.adoc[import $ivy] or
...
single xref:extending/import-mvn-plugins.adoc[import $ivy].
