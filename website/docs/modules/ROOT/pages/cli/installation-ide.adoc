...
`.bsp/mill-bsp-out` under the project workspace. This ensures BSP mode is not blocked by regular
...
`.bsp/mill-bsp-out/mill-bsp/`, where you can find various information about what's
