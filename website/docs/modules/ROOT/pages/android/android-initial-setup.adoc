...
> ./mill app.androidEmulator

# Run with additional arguments
> ./mill app.androidEmulator -noaudio

# Exclude default arguments
> ./mill app.androidEmulator --excludeDefaultArgs -avd test_avd
----
...
=== Install your application on the running emulator
This will install apk built by the `app.androidApk` command.
[source,console]
----
...
[source,console]
----
> ./mill clean app.androidEmulator
----
