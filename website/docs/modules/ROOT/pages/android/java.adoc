...
After creating a Simple Android Application, let's focus on how to create an Android App Bundle using the Mill Build Tool.
...
== Customising Android Sdk setup

include::partial$example/androidlib/java/7-customise-android-sdk.adoc[]