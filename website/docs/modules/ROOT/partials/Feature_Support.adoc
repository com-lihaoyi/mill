...
* xref:javalib/intro.adoc[Java], xref:kotlinlib/intro.adoc[Kotlin], xref:scalalib/intro.adoc[Scala], xref:android/android-initial-setup.adoc[Android]


*Dependency Management*

* xref:javalib/dependencies.adoc#_basic_dependencies_configuration[Compile & Runtime Dependencies]
* xref:fundamentals/library-deps.adoc#_dependency_management[Dependency Version Management and BOMs]
* xref:contrib/sbom.adoc[Software Bill of Materials (SBOMs)]
...
* xref:javalib/testing.adoc#_basic_testing_configuration[JUnit4, JUnit5, TestNG, ScalaTest, Specs2, Munit]
* xref:javalib/testing.adoc[Integration Testing]
...
* xref:javalib/packaging.adoc#_building_executable_assemblies[Executable Assemblies]
* xref:javalib/packaging.adoc#_building_native_image_binaries_with_graal_vm[Graal Native Image], xref:javalib/packaging.adoc#_java_app_and_bundles_using_jlink[JLink], xref:javalib/packaging.adoc#_java_installers_using_jpackage[JPackage]
* xref:contrib/docker.adoc[Docker]

*Publishing*

* xref:javalib/publishing.adoc#_publishing_to_maven_central[Maven Central], xref:contrib/artifactory.adoc[Artifactory]


*Web Frameworks*

* xref:javalib/spring-boot.adoc[Spring Boot], xref:javalib/web-examples.adoc#_micronaut_todomvc_app[Micronaut]
...
* xref:scalalib/web-examples.adoc#_todomvc_web_app[Cask], xref:scalalib/web-examples.adoc#_todomvc_http4s_web_app[Http4s], xref:scalalib/web-examples.adoc#_scala_js_webserver_integration[Scala.js]


*Others*

* xref:javalib/module-config.adoc#_annotation_processors[Java Annotation Processors], xref:kotlinlib/module-config.adoc#_kotlin_compiler_plugins[Kotlin Compiler Plugins],  xref:kotlinlib/module-config.adoc#_annotation_processing_with_kapt[Kapt], xref:kotlinlib/module-config.adoc#_dependency_injection_with_dagger_and_ksp[KSP], xref:scalalib/module-config.adoc#_scala_compiler_plugins[Scala Compiler Plugins]
