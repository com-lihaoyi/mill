...
* xref:javalib/module-config.adoc#_annotation_processors[Java Annotation Processors], xref:kotlinlib/module-config.adoc#_kotlin_compiler_plugins[Kotlin Compiler Plugins],  xref:kotlinlib/module-config.adoc#_dependency_injection_with_dagger_and_ksp[KSP], xref:scalalib/module-config.adoc#_scala_compiler_plugins[Scala Compiler Plugins]
