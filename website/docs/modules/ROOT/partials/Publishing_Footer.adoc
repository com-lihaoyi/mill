...
Below you are values you could override in the `SonatypeCentralPublishModule`.
...
=== Upload Public Key for Artifacts Verification
...
`mill.scalalib.sonatypecentral.SonatypeCentralPublishModule/publishAll`:
...
You can also specify individual modules you want to publish:
