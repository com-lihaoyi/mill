...
Wall-clock times were collected over five runs per tool, and the reported values represent the average of those runs, for both clean builds (`clean` + build) and incremental builds (source modification without cleaning).
