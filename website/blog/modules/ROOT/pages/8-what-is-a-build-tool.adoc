...
fundamental level they use the sort of graph traversal that I discuss above. They all
perform some amount of caching and parallelism, because that is necessary in order
to keep dev workflows fast and responsive even as the codebase grows.
