...
* xref:mill:ROOT:javalib/packaging.adoc#_building_native_image_binaries_with_graal_vm[Building Native Image Binaries with Graal VM]
...
jobs:
  publish-sonatype:
    ...
    steps:
      ...
      - run: ./mill mill.scalalib.PublishModule/ --publishArtifacts ${{ matrix.publishartifacts }}
----
