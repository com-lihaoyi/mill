...
At a high level, the distinction between these is as follows:

1. Class Hierarchy Analysis considers for each virtual method call and considers the
   possibility that it might call any class that implements that method globall
