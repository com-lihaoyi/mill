...
The development efforts to support Dependency Injection architectures with Hilt for Android: Source code generation, Kotlin Symbol Processing and bytecode manipulation!
