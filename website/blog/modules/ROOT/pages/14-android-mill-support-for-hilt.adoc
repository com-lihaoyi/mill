...
When you add Hilt to the mix—bringing in code generation and bytecode rewriting—the complexity increases. Supporting this correctly meant understanding how Gradle orchestrates these steps and implementing a Mill idiomatic process that achieves equivalent results in a Mill-idiomatic approach.
