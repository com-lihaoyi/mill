...
and the necessary config is in the xref:#_footnotes[footnotes]. I have no doubt most people would
be able to get __something__ working on their machine. But for someone trying to write a small
