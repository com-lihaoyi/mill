...
using the https://bitbucket.org/snakeyaml/snakeyaml-engine[SnakeYaml-Engine] library and
de-serialized using https://github.com/com-lihaoyi/upickle[uPickle]. This helps mitigate a lot
of the issues that YAML has traditionally faced, 
