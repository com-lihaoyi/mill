...
and xref:mill::comparisons/gradle.adoc#_ide_support[IDE support].
...
Mill has always had a xref:mill::comparisons/gradle.adoc#_ide_support[best-in-class IDE experience]
