...
xref:mill::comparisons/performance.adoc[],
xref:mill::comparisons/gradle.adoc#_extending_mill[extensibility],
and xref:mill::comparisons/gradle.adoc#_gradle_ide_support[IDE support].
...
{mill-github-url}/blob/main/changelog.adoc#1-0-0[Changelog] contains a thorough
...
xref:mill::javalib/packaging.adoc#_building_native_image_binaries_with_graal_vm[Building
...
Mill has always had a xref:mill::comparisons/gradle.adoc#_gradle_ide_support[best-in-class IDE experience]
...
- You are now much free-er to use or upgrade third-party dependencies
  ...
  because xref:mill::comparisons/gradle.adoc#_extending_mill[extending Mill
...
- {mill-github-url}/blob/main/changelog.adoc#1-0-0[Mill 1.0.0 Changelog]
