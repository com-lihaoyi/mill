...
to turn on, without needing the user to tune group sizes or thread counts and other things
that old parallelism strategies required to perform well. This simplifies the user experience,
