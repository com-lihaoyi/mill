...
({mill-github-url}/blob/main/changelog.adoc#1-1-0[changelog])
...
and maintaining your Java projects much easier than when using traditional build tools.
...
[cols="2,2"]
|===
| xref:mill::javalib/intro.adoc#_declarative_configuration[Java Declarative Module Configuration]
| xref:mill::javalib/intro.adoc#_single_file_scripts[Java Single-File Scripts]

| xref:mill::kotlinlib/intro.adoc#_declarative_configuration[Kotlin Declarative Module Configuration]
| xref:mill::kotlinlib/intro.adoc#_single_file_scripts[Kotlin Single-File Scripts]

| xref:mill::scalalib/intro.adoc#_declarative_configuration[Scala Declarative Module Configuration]
...
- {mill-github-url}/blob/main/changelog.adoc#1-1-0[Mill 1.1.0 Changelog]
