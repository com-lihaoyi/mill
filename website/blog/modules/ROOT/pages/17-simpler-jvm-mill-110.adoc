...
and execution - but every step is cached and parallelized to be as fast possible. Scripts can be
xref:mill::javalib/script.adoc#_packaging_assemblies_and_native_binaries[packaged into assemblies or
native images], have xref:mill::javalib/intro.adoc#_testing_scripts[tests], and generally have the
full featureset of the Mill build tool available to them.
