...
xref:mill::extending/import-mvn-plugins.adoc#_importing_java_libraries[Thymeleaf] templating engine is
available with a single import, as is the popular
xref:mill::extending/import-mvn-plugins.adoc#_importing_scala_libraries[Scalatags] templating engine.
...
xref:mill::extending/import-mvn-plugins.adoc[extensibility]. Mill
