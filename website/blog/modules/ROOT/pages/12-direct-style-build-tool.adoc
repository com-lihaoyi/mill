...
xref:mill::comparisons/performance.adoc[] over existing Java build tools
...
templating/declarative/scripting languages in an intricate dance of callbacks and filesystem
