  ...
  def tests: Tests = Tests {
    ...
    test("scalaDocOptions") {
      ...
      test("docJarWithVersion") - UnitTester(
        ...
        val Left(Result.Failure(_, None)) = eval.apply(HelloWorldWithDocVersion.core.docJar): @unchecked
      }
      test("docJarOnlyVersion") - UnitTester(
        ...
        val Left(Result.Failure(_, None)) = eval.apply(HelloWorldOnlyDocVersion.core.docJar): @unchecked
      }
    }
