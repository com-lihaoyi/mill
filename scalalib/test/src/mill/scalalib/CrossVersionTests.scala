...
object CrossVersionTests extends TestSuite {
  ...
  object TestCases extends TestBaseModule {
    ...
    object StandaloneScala213 extends ScalaModule {
      ...
      override def libraryDeps = Seq(ivy"com.lihaoyi::upickle:1.4.0")
    }
    ...
    object JavaDependsOnScala213 extends JavaModule {
      ...
      override def libraryDeps = Seq(ivy"org.slf4j:slf4j-api:1.7.35")
    }
    ...
    object Scala3DependsOnScala213 extends ScalaModule {
      ...
      override def moduleDeps = Seq(StandaloneScala213)
      override def libraryDeps = Seq(ivy"com.lihaoyi::sourcecode:0.2.7")
    }
  ...
  def check(
      ...
      expectedLibraryDepsTree: Option[String] = None
  )(implicit
      testPath: TestPath
  ) = {
    val eval = init()
    eval.apply(mod.libraryDepsTree(LibraryDepsTreeArgs()))

    expectedLibraryDepsTree.foreach { tree =>
      if (!scala.util.Properties.isWin) {
        ...
        val depsTree =
          os.read(ExecutionPaths.resolve(
            eval.outPath,
            mod.libraryDepsTree(LibraryDepsTreeArgs())
          ).log)
  ...
  def tests: Tests = Tests {
    ...
    test("StandaloneScala213") {
      check(
        ...
        expectedLibraryDepsTree = Some(StandaloneScala213.tree)
      )
    }
    ...
    test("JavaDependsOnScala213") {
      check(
        ...
        expectedLibraryDepsTree = Some(JavaDependsOnScala213.tree)
      )
    }
    ...
    test("Scala3DependsOnScala213") {
      check(
        ...
        expectedLibraryDepsTree = Some(Scala3DependsOnScala213.tree)
      )
    }
    ...
    test("JavaDependsOnScala3") {
      check(
        ...
        expectedLibraryDepsTree = Some(JavaDependsOnScala3.tree)
      )
    }
    ...
    test("sndwitch3") {
      check(
        ...
        expectedLibraryDepsTree = Some(sandwitch213.tree)
      )
    }
