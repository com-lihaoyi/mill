...
object License {
  ...
  val `Adobe-2006`: License =
    spdx("Adobe Systems Incorporated Source Code License Agreement", "Adobe-2006", false, false)
  val `Adobe-Glyph`: License = spdx("Adobe Glyph List License", "Adobe-Glyph", false, false)
  val ADSL: License = spdx("Amazon Digital Services License", "ADSL", false, false)
  val `AFL-1.1`: License = spdx("Academic Free License v1.1", "AFL-1.1", true, true)
  val `AFL-1.2`: License = spdx("Academic Free License v1.2", "AFL-1.2", true, true)
  val `AFL-2.0`: License = spdx("Academic Free License v2.0", "AFL-2.0", true, true)
  val `AFL-2.1`: License = spdx("Academic Free License v2.1", "AFL-2.1", true, true)
  val `AFL-3.0`: License = spdx("Academic Free License v3.0", "AFL-3.0", true, true)
  val Afmparse: License = spdx("Afmparse License", "Afmparse", false, false)
  val `AGPL-1.0`: License = spdx("Affero General Public License v1.0", "AGPL-1.0", false, true)
  val `AGPL-3.0-only`: License =
    spdx("GNU Affero General Public License v3.0 only", "AGPL-3.0-only", true, false)
  val `AGPL-3.0-or-later`: License =
  ...
  val `ANTLR-PD`: License = spdx("ANTLR Software Rights Notice", "ANTLR-PD", false, false)
  val `Apache-1.0`: License = spdx("Apache License 1.0", "Apache-1.0", false, true)
  val `Apache-1.1`: License = spdx("Apache License 1.1", "Apache-1.1", true, true)
  val `Apache-2.0`: License = spdx("Apache License 2.0", "Apache-2.0", true, true)
  val APAFML: License = spdx("Adobe Postscript AFM License", "APAFML", false, false)
  val `APL-1.0`: License = spdx("Adaptive Public License 1.0", "APL-1.0", true, false)
  val `APSL-1.0`: License = spdx("Apple Public Source License 1.0", "APSL-1.0", true, false)
  val `APSL-1.1`: License = spdx("Apple Public Source License 1.1", "APSL-1.1", true, false)
  val `APSL-1.2`: License = spdx("Apple Public Source License 1.2", "APSL-1.2", true, false)
  val `APSL-2.0`: License = spdx("Apple Public Source License 2.0", "APSL-2.0", true, true)
  val `Artistic-1.0-cl8`: License =
    spdx("Artistic License 1.0 w/clause 8", "Artistic-1.0-cl8", true, false)
  val `Artistic-1.0-Perl`: License =
    spdx("Artistic License 1.0 (Perl)", "Artistic-1.0-Perl", true, false)
  val `Artistic-1.0`: License = spdx("Artistic License 1.0", "Artistic-1.0", true, false)
  val `Artistic-2.0`: License = spdx("Artistic License 2.0", "Artistic-2.0", true, true)
  ...
  val `CATOSL-1.1`: License =
    spdx("Computer Associates Trusted Open Source License 1.1", "CATOSL-1.1", true, false)
  val `CC-BY-1.0`: License = spdx("Creative Commons Attribution 1.0", "CC-BY-1.0", false, false)
  val `CC-BY-2.0`: License = spdx("Creative Commons Attribution 2.0", "CC-BY-2.0", false, false)
  val `CC-BY-2.5`: License = spdx("Creative Commons Attribution 2.5", "CC-BY-2.5", false, false)
  val `CC-BY-3.0`: License = spdx("Creative Commons Attribution 3.0", "CC-BY-3.0", false, false)
  val `CC-BY-4.0`: License = spdx("Creative Commons Attribution 4.0", "CC-BY-4.0", false, true)
  val `CC-BY-NC-1.0`: License =
    spdx("Creative Commons Attribution Non Commercial 1.0", "CC-BY-NC-1.0", false, false)
  val `CC-BY-NC-2.0`: License =
    spdx("Creative Commons Attribution Non Commercial 2.0", "CC-BY-NC-2.0", false, false)
  val `CC-BY-NC-2.5`: License =
    spdx("Creative Commons Attribution Non Commercial 2.5", "CC-BY-NC-2.5", false, false)
  val `CC-BY-NC-3.0`: License =
    spdx("Creative Commons Attribution Non Commercial 3.0", "CC-BY-NC-3.0", false, false)
  val `CC-BY-NC-4.0`: License =
    spdx("Creative Commons Attribution Non Commercial 4.0", "CC-BY-NC-4.0", false, false)
  val `CC-BY-NC-ND-1.0`: License = spdx(
    "Creative Commons Attribution Non Commercial No Derivatives 1.0",
    "CC-BY-NC-ND-1.0",
    false,
    false
  )
  val `CC-BY-NC-ND-2.0`: License = spdx(
    "Creative Commons Attribution Non Commercial No Derivatives 2.0",
    "CC-BY-NC-ND-2.0",
    false,
    false
  )
  val `CC-BY-NC-ND-2.5`: License = spdx(
    "Creative Commons Attribution Non Commercial No Derivatives 2.5",
    "CC-BY-NC-ND-2.5",
    false,
    false
  )
  val `CC-BY-NC-ND-3.0`: License = spdx(
    "Creative Commons Attribution Non Commercial No Derivatives 3.0",
    "CC-BY-NC-ND-3.0",
    false,
    false
  )
  val `CC-BY-NC-ND-4.0`: License = spdx(
    "Creative Commons Attribution Non Commercial No Derivatives 4.0",
    "CC-BY-NC-ND-4.0",
    false,
    false
  )
  val `CC-BY-NC-SA-1.0`: License = spdx(
    "Creative Commons Attribution Non Commercial Share Alike 1.0",
    "CC-BY-NC-SA-1.0",
    false,
    false
  )
  val `CC-BY-NC-SA-2.0`: License = spdx(
    "Creative Commons Attribution Non Commercial Share Alike 2.0",
    "CC-BY-NC-SA-2.0",
    false,
    false
  )
  val `CC-BY-NC-SA-2.5`: License = spdx(
    "Creative Commons Attribution Non Commercial Share Alike 2.5",
    "CC-BY-NC-SA-2.5",
    false,
    false
  )
  val `CC-BY-NC-SA-3.0`: License = spdx(
    "Creative Commons Attribution Non Commercial Share Alike 3.0",
    "CC-BY-NC-SA-3.0",
    false,
    false
  )
  val `CC-BY-NC-SA-4.0`: License = spdx(
    "Creative Commons Attribution Non Commercial Share Alike 4.0",
    "CC-BY-NC-SA-4.0",
    false,
    false
  )
  val `CC-BY-ND-1.0`: License =
    spdx("Creative Commons Attribution No Derivatives 1.0", "CC-BY-ND-1.0", false, false)
  val `CC-BY-ND-2.0`: License =
    spdx("Creative Commons Attribution No Derivatives 2.0", "CC-BY-ND-2.0", false, false)
  val `CC-BY-ND-2.5`: License =
    spdx("Creative Commons Attribution No Derivatives 2.5", "CC-BY-ND-2.5", false, false)
  val `CC-BY-ND-3.0`: License =
    spdx("Creative Commons Attribution No Derivatives 3.0", "CC-BY-ND-3.0", false, false)
  val `CC-BY-ND-4.0`: License =
    spdx("Creative Commons Attribution No Derivatives 4.0", "CC-BY-ND-4.0", false, false)
  val `CC-BY-SA-1.0`: License =
    spdx("Creative Commons Attribution Share Alike 1.0", "CC-BY-SA-1.0", false, false)
  val `CC-BY-SA-2.0`: License =
    spdx("Creative Commons Attribution Share Alike 2.0", "CC-BY-SA-2.0", false, false)
  val `CC-BY-SA-2.5`: License =
    spdx("Creative Commons Attribution Share Alike 2.5", "CC-BY-SA-2.5", false, false)
  val `CC-BY-SA-3.0`: License =
    spdx("Creative Commons Attribution Share Alike 3.0", "CC-BY-SA-3.0", false, false)
  val `CC-BY-SA-4.0`: License =
    spdx("Creative Commons Attribution Share Alike 4.0", "CC-BY-SA-4.0", false, true)
  val `CC0-1.0`: License = spdx("Creative Commons Zero v1.0 Universal", "CC0-1.0", false, true)
  val `CDDL-1.0`: License =
    spdx("Common Development and Distribution License 1.0", "CDDL-1.0", true, true)
  val `CDDL-1.1`: License =
    spdx("Common Development and Distribution License 1.1", "CDDL-1.1", false, false)
  val `CDLA-Permissive-1.0`: License =
    spdx("Community Data License Agreement Permissive 1.0", "CDLA-Permissive-1.0", false, false)
  val `CDLA-Sharing-1.0`: License =
    spdx("Community Data License Agreement Sharing 1.0", "CDLA-Sharing-1.0", false, false)
  val `CECILL-1.0`: License =
    spdx("CeCILL Free Software License Agreement v1.0", "CECILL-1.0", false, false)
  val `CECILL-1.1`: License =
    spdx("CeCILL Free Software License Agreement v1.1", "CECILL-1.1", false, false)
  val `CECILL-2.0`: License =
    spdx("CeCILL Free Software License Agreement v2.0", "CECILL-2.0", false, true)
  val `CECILL-2.1`: License =
    spdx("CeCILL Free Software License Agreement v2.1", "CECILL-2.1", true, false)
  val `CECILL-B`: License =
    spdx("CeCILL-B Free Software License Agreement", "CECILL-B", false, true)
  val `CECILL-C`: License =
  ...
  val `CNRI-Jython`: License = spdx("CNRI Jython License", "CNRI-Jython", false, false)
  val `CNRI-Python-GPL-Compatible`: License = spdx(
    "CNRI Python Open Source GPL Compatible License Agreement",
    "CNRI-Python-GPL-Compatible",
    false,
    false
  )
  val `CNRI-Python`: License = spdx("CNRI Python License", "CNRI-Python", true, false)
  val `Condor-1.1`: License = spdx("Condor Public License v1.1", "Condor-1.1", false, true)
  val `CPAL-1.0`: License = spdx("Common Public Attribution License 1.0", "CPAL-1.0", true, true)
  val `CPL-1.0`: License = spdx("Common Public License 1.0", "CPL-1.0", true, true)
  val `CPOL-1.02`: License = spdx("Code Project Open License 1.02", "CPOL-1.02", false, false)
  ...
  val `CUA-OPL-1.0`: License = spdx("CUA Office Public License v1.0", "CUA-OPL-1.0", true, false)
  val Cube: License = spdx("Cube License", "Cube", false, false)
  val curl: License = spdx("curl License", "curl", false, false)
  val `D-FSL-1.0`: License = spdx("Deutsche Freie Software Lizenz", "D-FSL-1.0", false, false)
  ...
  val `ECL-1.0`: License = spdx("Educational Community License v1.0", "ECL-1.0", true, false)
  val `ECL-2.0`: License = spdx("Educational Community License v2.0", "ECL-2.0", true, true)
  val `EFL-1.0`: License = spdx("Eiffel Forum License v1.0", "EFL-1.0", true, false)
  val `EFL-2.0`: License = spdx("Eiffel Forum License v2.0", "EFL-2.0", true, true)
  ...
  val `EPL-1.0`: License = spdx("Eclipse Public License 1.0", "EPL-1.0", true, true)
  val `EPL-2.0`: License = spdx("Eclipse Public License 2.0", "EPL-2.0", true, true)
  val `ErlPL-1.1`: License = spdx("Erlang Public License v1.1", "ErlPL-1.1", false, false)
  val EUDatagrid: License = spdx("EU DataGrid Software License", "EUDatagrid", true, true)
  val `EUPL-1.0`: License = spdx("European Union Public License 1.0", "EUPL-1.0", false, false)
  val `EUPL-1.1`: License = spdx("European Union Public License 1.1", "EUPL-1.1", true, true)
  val `EUPL-1.2`: License = spdx("European Union Public License 1.2", "EUPL-1.2", true, false)
  val Eurosym: License = spdx("Eurosym License", "Eurosym", false, false)
  val Fair: License = spdx("Fair License", "Fair", true, false)
  val `Frameworx-1.0`: License = spdx("Frameworx Open License 1.0", "Frameworx-1.0", true, false)
  ...
  val `IBM-pibs`: License =
    spdx("IBM PowerPC Initialization and Boot Software", "IBM-pibs", false, false)
  ...
  val `Info-ZIP`: License = spdx("Info-ZIP License", "Info-ZIP", false, false)
  val `Intel-ACPI`: License =
  ...
  val `Interbase-1.0`: License =
    spdx("Interbase Public License v1.0", "Interbase-1.0", false, false)
  val IPA: License = spdx("IPA Font License", "IPA", true, true)
  val `IPL-1.0`: License = spdx("IBM Public License v1.0", "IPL-1.0", true, true)
  val ISC: License = spdx("ISC License", "ISC", true, true)
  val `JasPer-2.0`: License = spdx("JasPer License", "JasPer-2.0", false, false)
  val JSON: License = spdx("JSON License", "JSON", false, false)
  val `LAL-1.2`: License = spdx("Licence Art Libre 1.2", "LAL-1.2", false, false)
  val `LAL-1.3`: License = spdx("Licence Art Libre 1.3", "LAL-1.3", false, false)
  ...
  val `LiLiQ-P-1.1`: License =
    spdx("Licence Libre du Québec – Permissive version 1.1", "LiLiQ-P-1.1", true, false)
  val `LiLiQ-R-1.1`: License =
    spdx("Licence Libre du Québec – Réciprocité version 1.1", "LiLiQ-R-1.1", true, false)
  val `LiLiQ-Rplus-1.1`: License =
    spdx("Licence Libre du Québec – Réciprocité forte version 1.1", "LiLiQ-Rplus-1.1", true, false)
  val `LPL-1.0`: License = spdx("Lucent Public License Version 1.0", "LPL-1.0", true, false)
  val `LPL-1.02`: License = spdx("Lucent Public License v1.02", "LPL-1.02", true, true)
  val `LPPL-1.0`: License = spdx("LaTeX Project Public License v1.0", "LPPL-1.0", false, false)
  val `LPPL-1.1`: License = spdx("LaTeX Project Public License v1.1", "LPPL-1.1", false, false)
  val `LPPL-1.2`: License = spdx("LaTeX Project Public License v1.2", "LPPL-1.2", false, true)
  val `LPPL-1.3a`: License = spdx("LaTeX Project Public License v1.3a", "LPPL-1.3a", false, true)
  val `LPPL-1.3c`: License = spdx("LaTeX Project Public License v1.3c", "LPPL-1.3c", true, false)
  val MakeIndex: License = spdx("MakeIndex License", "MakeIndex", false, false)
  val MirOS: License = spdx("MirOS License", "MirOS", true, false)
  val `MIT-advertising`: License =
    spdx("Enlightenment License (e16)", "MIT-advertising", false, false)
  val `MIT-CMU`: License = spdx("CMU License", "MIT-CMU", false, false)
  val `MIT-enna`: License = spdx("enna License", "MIT-enna", false, false)
  val `MIT-feh`: License = spdx("feh License", "MIT-feh", false, false)
  ...
  val `MPL-1.0`: License = spdx("Mozilla Public License 1.0", "MPL-1.0", true, false)
  val `MPL-1.1`: License = spdx("Mozilla Public License 1.1", "MPL-1.1", true, true)
  val `MPL-2.0-no-copyleft-exception`: License = spdx(
    "Mozilla Public License 2.0 (no copyleft exception)",
    "MPL-2.0-no-copyleft-exception",
    true,
    false
  )
  val `MPL-2.0`: License = spdx("Mozilla Public License 2.0", "MPL-2.0", true, true)
  val `MS-PL`: License = spdx("Microsoft Public License", "MS-PL", true, true)
  val `MS-RL`: License = spdx("Microsoft Reciprocal License", "MS-RL", true, true)
  ...
  val `NASA-1.3`: License = spdx("NASA Open Source Agreement 1.3", "NASA-1.3", true, false)
  val Naumen: License = spdx("Naumen Public License", "Naumen", true, false)
  val `NBPL-1.0`: License = spdx("Net Boolean Public License v1", "NBPL-1.0", false, false)
  val NCSA: License = spdx("University of Illinois/NCSA Open Source License", "NCSA", true, true)
  val `Net-SNMP`: License = spdx("Net-SNMP License", "Net-SNMP", false, false)
  ...
  val `NPL-1.0`: License = spdx("Netscape Public License v1.0", "NPL-1.0", false, true)
  val `NPL-1.1`: License = spdx("Netscape Public License v1.1", "NPL-1.1", false, true)
  val `NPOSL-3.0`: License = spdx("Non-Profit Open Software License 3.0", "NPOSL-3.0", true, false)
  val NRL: License = spdx("NRL License", "NRL", false, false)
  val NTP: License = spdx("NTP License", "NTP", true, false)
  val `OCCT-PL`: License = spdx("Open CASCADE Technology Public License", "OCCT-PL", false, false)
  val `OCLC-2.0`: License = spdx("OCLC Research Public License 2.0", "OCLC-2.0", true, false)
  val `ODbL-1.0`: License = spdx("ODC Open Database License v1.0", "ODbL-1.0", false, true)
  val `OFL-1.0`: License = spdx("SIL Open Font License 1.0", "OFL-1.0", false, false)
  val `OFL-1.1`: License = spdx("SIL Open Font License 1.1", "OFL-1.1", true, true)
  val OGTSL: License = spdx("Open Group Test Suite License", "OGTSL", true, false)
  val `OLDAP-1.1`: License = spdx("Open LDAP Public License v1.1", "OLDAP-1.1", false, false)
  val `OLDAP-1.2`: License = spdx("Open LDAP Public License v1.2", "OLDAP-1.2", false, false)
  val `OLDAP-1.3`: License = spdx("Open LDAP Public License v1.3", "OLDAP-1.3", false, false)
  val `OLDAP-1.4`: License = spdx("Open LDAP Public License v1.4", "OLDAP-1.4", false, false)
  val `OLDAP-2.0.1`: License = spdx("Open LDAP Public License v2.0.1", "OLDAP-2.0.1", false, false)
  val `OLDAP-2.0`: License =
    spdx("Open LDAP Public License v2.0 (or possibly 2.0A and 2.0B)", "OLDAP-2.0", false, false)
  val `OLDAP-2.1`: License = spdx("Open LDAP Public License v2.1", "OLDAP-2.1", false, false)
  val `OLDAP-2.2.1`: License = spdx("Open LDAP Public License v2.2.1", "OLDAP-2.2.1", false, false)
  val `OLDAP-2.2.2`: License = spdx("Open LDAP Public License 2.2.2", "OLDAP-2.2.2", false, false)
  val `OLDAP-2.2`: License = spdx("Open LDAP Public License v2.2", "OLDAP-2.2", false, false)
  val `OLDAP-2.3`: License = spdx("Open LDAP Public License v2.3", "OLDAP-2.3", false, true)
  val `OLDAP-2.4`: License = spdx("Open LDAP Public License v2.4", "OLDAP-2.4", false, false)
  val `OLDAP-2.5`: License = spdx("Open LDAP Public License v2.5", "OLDAP-2.5", false, false)
  val `OLDAP-2.6`: License = spdx("Open LDAP Public License v2.6", "OLDAP-2.6", false, false)
  val `OLDAP-2.7`: License = spdx("Open LDAP Public License v2.7", "OLDAP-2.7", false, true)
  val `OLDAP-2.8`: License = spdx("Open LDAP Public License v2.8", "OLDAP-2.8", false, false)
  val OML: License = spdx("Open Market License", "OML", false, false)
  val OpenSSL: License = spdx("OpenSSL License", "OpenSSL", false, true)
  val `OPL-1.0`: License = spdx("Open Public License v1.0", "OPL-1.0", false, false)
  val `OSET-PL-2.1`: License = spdx("OSET Public License version 2.1", "OSET-PL-2.1", true, false)
  val `OSL-1.0`: License = spdx("Open Software License 1.0", "OSL-1.0", true, true)
  val `OSL-1.1`: License = spdx("Open Software License 1.1", "OSL-1.1", false, true)
  val `OSL-2.0`: License = spdx("Open Software License 2.0", "OSL-2.0", true, true)
  val `OSL-2.1`: License = spdx("Open Software License 2.1", "OSL-2.1", true, true)
  val `OSL-3.0`: License = spdx("Open Software License 3.0", "OSL-3.0", true, true)
  val `PDDL-1.0`: License =
    spdx("ODC Public Domain Dedication & License 1.0", "PDDL-1.0", false, false)
  val `PHP-3.0`: License = spdx("PHP License v3.0", "PHP-3.0", true, false)
  val `PHP-3.01`: License = spdx("PHP License v3.01", "PHP-3.01", false, true)
  ...
  val `Python-2.0`: License = spdx("Python License 2.0", "Python-2.0", true, true)
  val Qhull: License = spdx("Qhull License", "Qhull", false, false)
  val `QPL-1.0`: License = spdx("Q Public License 1.0", "QPL-1.0", true, true)
  val Rdisc: License = spdx("Rdisc License", "Rdisc", false, false)
  val `RHeCos-1.1`: License = spdx("Red Hat eCos Public License v1.1", "RHeCos-1.1", false, false)
  val `RPL-1.1`: License = spdx("Reciprocal Public License 1.1", "RPL-1.1", true, false)
  val `RPL-1.5`: License = spdx("Reciprocal Public License 1.5", "RPL-1.5", true, false)
  val `RPSL-1.0`: License = spdx("RealNetworks Public Source License v1.0", "RPSL-1.0", true, true)
  val `RSA-MD`: License = spdx("RSA Message-Digest License ", "RSA-MD", false, false)
  ...
  val `SAX-PD`: License = spdx("Sax Public Domain Notice", "SAX-PD", false, false)
  ...
  val `SGI-B-1.0`: License = spdx("SGI Free Software License B v1.0", "SGI-B-1.0", false, false)
  val `SGI-B-1.1`: License = spdx("SGI Free Software License B v1.1", "SGI-B-1.1", false, false)
  val `SGI-B-2.0`: License = spdx("SGI Free Software License B v2.0", "SGI-B-2.0", false, true)
  val `SimPL-2.0`: License = spdx("Simple Public License 2.0", "SimPL-2.0", true, false)
  val `SISSL-1.2`: License =
    spdx("Sun Industry Standards Source License v1.2", "SISSL-1.2", false, false)
  ...
  val `Spencer-86`: License = spdx("Spencer License 86", "Spencer-86", false, false)
  val `Spencer-94`: License = spdx("Spencer License 94", "Spencer-94", false, false)
  val `Spencer-99`: License = spdx("Spencer License 99", "Spencer-99", false, false)
  val `SPL-1.0`: License = spdx("Sun Public License v1.0", "SPL-1.0", true, true)
  val `SugarCRM-1.1.3`: License =
  ...
  val `TCP-wrappers`: License = spdx("TCP Wrappers License", "TCP-wrappers", false, false)
  val TMate: License = spdx("TMate Open Source License", "TMate", false, false)
  val `TORQUE-1.1`: License = spdx("TORQUE v2.5+ Software License v1.1", "TORQUE-1.1", false, false)
  val TOSL: License = spdx("Trusster Open Source License", "TOSL", false, false)
  val `Unicode-DFS-2015`: License = spdx(
    "Unicode License Agreement - Data Files and Software (2015)",
    "Unicode-DFS-2015",
    false,
    false
  )
  val `Unicode-DFS-2016`: License = spdx(
    "Unicode License Agreement - Data Files and Software (2016)",
    "Unicode-DFS-2016",
    false,
    false
  )
  val `Unicode-TOU`: License = spdx("Unicode Terms of Use", "Unicode-TOU", false, false)
  val Unlicense: License = spdx("The Unlicense", "Unlicense", false, true)
  val `UPL-1.0`: License = spdx("Universal Permissive License v1.0", "UPL-1.0", true, true)
  ...
  val `VSL-1.0`: License = spdx("Vovida Software License v1.0", "VSL-1.0", true, false)
  val `W3C-19980720`: License =
    spdx("W3C Software Notice and License (1998-07-20)", "W3C-19980720", false, false)
  val `W3C-20150513`: License =
  ...
  val `XFree86-1.1`: License = spdx("XFree86 License 1.1", "XFree86-1.1", false, true)
  ...
  val `YPL-1.0`: License = spdx("Yahoo! Public License v1.0", "YPL-1.0", false, false)
  val `YPL-1.1`: License = spdx("Yahoo! Public License v1.1", "YPL-1.1", false, true)
  val Zed: License = spdx("Zed License", "Zed", false, false)
  val `Zend-2.0`: License = spdx("Zend License v2.0", "Zend-2.0", false, true)
  val `Zimbra-1.3`: License = spdx("Zimbra Public License v1.3", "Zimbra-1.3", false, true)
  val `Zimbra-1.4`: License = spdx("Zimbra Public License v1.4", "Zimbra-1.4", false, false)
  val `zlib-acknowledgement`: License =
  ...
  val `ZPL-1.1`: License = spdx("Zope Public License 1.1", "ZPL-1.1", false, false)
  val `ZPL-2.0`: License = spdx("Zope Public License 2.0", "ZPL-2.0", true, true)
  val `ZPL-2.1`: License = spdx("Zope Public License 2.1", "ZPL-2.1", false, true)
  val `AGPL-3.0`: License = spdx("GNU Affero General Public License v3.0", "AGPL-3.0", true, false)
  val `eCos-2.0`: License = spdx("eCos license version 2.0", "eCos-2.0", false, false)
  val `GFDL-1.1`: License = spdx("GNU Free Documentation License v1.1", "GFDL-1.1", false, false)
  val `GFDL-1.2`: License = spdx("GNU Free Documentation License v1.2", "GFDL-1.2", false, false)
  val `GFDL-1.3`: License = spdx("GNU Free Documentation License v1.3", "GFDL-1.3", false, false)
  val `GPL-1.0+`: License =
    spdx("GNU General Public License v1.0 or later", "GPL-1.0+", false, false)
  val `GPL-1.0`: License = spdx("GNU General Public License v1.0 only", "GPL-1.0", false, false)
  val `GPL-2.0+`: License =
    spdx("GNU General Public License v2.0 or later", "GPL-2.0+", true, false)
  val `GPL-2.0-with-autoconf-exception`: License = spdx(
    "GNU General Public License v2.0 w/Autoconf exception",
    "GPL-2.0-with-autoconf-exception",
    false,
    false
  )
  val `GPL-2.0-with-bison-exception`: License = spdx(
    "GNU General Public License v2.0 w/Bison exception",
    "GPL-2.0-with-bison-exception",
    false,
    false
  )
  val `GPL-2.0-with-classpath-exception`: License = spdx(
    "GNU General Public License v2.0 w/Classpath exception",
    "GPL-2.0-with-classpath-exception",
    false,
    false
  )
  val `GPL-2.0-with-font-exception`: License = spdx(
    "GNU General Public License v2.0 w/Font exception",
    "GPL-2.0-with-font-exception",
    false,
    false
  )
  val `GPL-2.0-with-GCC-exception`: License = spdx(
    "GNU General Public License v2.0 w/GCC Runtime Library exception",
    "GPL-2.0-with-GCC-exception",
    false,
    false
  )
  val `GPL-2.0`: License = spdx("GNU General Public License v2.0 only", "GPL-2.0", true, false)
  val `GPL-3.0+`: License =
    spdx("GNU General Public License v3.0 or later", "GPL-3.0+", true, false)
  val `GPL-3.0-with-autoconf-exception`: License = spdx(
    "GNU General Public License v3.0 w/Autoconf exception",
    "GPL-3.0-with-autoconf-exception",
    false,
    false
  )
  val `GPL-3.0-with-GCC-exception`: License = spdx(
    "GNU General Public License v3.0 w/GCC Runtime Library exception",
    "GPL-3.0-with-GCC-exception",
    true,
    false
  )
  val `GPL-3.0`: License = spdx("GNU General Public License v3.0 only", "GPL-3.0", true, false)
  val `LGPL-2.0+`: License =
    spdx("GNU Library General Public License v2 or later", "LGPL-2.0+", true, false)
  val `LGPL-2.0`: License =
    spdx("GNU Library General Public License v2 only", "LGPL-2.0", true, false)
  val `LGPL-2.1+`: License =
    spdx("GNU Library General Public License v2 or later", "LGPL-2.1+", true, false)
  val `LGPL-2.1`: License =
    spdx("GNU Lesser General Public License v2.1 only", "LGPL-2.1", true, false)
  val `LGPL-3.0+`: License =
