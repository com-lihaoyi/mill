...
object License {
  ...
  val `BSD-3-Clause-No-Nuclear-License-2014` =
    spdx("BSD 3-Clause No Nuclear License 2014", "BSD-3-Clause-No-Nuclear-License-2014", false, false)
  ...
  val `CC-BY-NC-ND-1.0` =
    spdx("Creative Commons Attribution Non Commercial No Derivatives 1.0", "CC-BY-NC-ND-1.0", false, false)
  val `CC-BY-NC-ND-2.0` =
    spdx("Creative Commons Attribution Non Commercial No Derivatives 2.0", "CC-BY-NC-ND-2.0", false, false)
  val `CC-BY-NC-ND-2.5` =
    spdx("Creative Commons Attribution Non Commercial No Derivatives 2.5", "CC-BY-NC-ND-2.5", false, false)
  val `CC-BY-NC-ND-3.0` =
    spdx("Creative Commons Attribution Non Commercial No Derivatives 3.0", "CC-BY-NC-ND-3.0", false, false)
  val `CC-BY-NC-ND-4.0` =
    spdx("Creative Commons Attribution Non Commercial No Derivatives 4.0", "CC-BY-NC-ND-4.0", false, false)
  val `CC-BY-NC-SA-1.0` =
    spdx("Creative Commons Attribution Non Commercial Share Alike 1.0", "CC-BY-NC-SA-1.0", false, false)
  val `CC-BY-NC-SA-2.0` =
    spdx("Creative Commons Attribution Non Commercial Share Alike 2.0", "CC-BY-NC-SA-2.0", false, false)
  val `CC-BY-NC-SA-2.5` =
    spdx("Creative Commons Attribution Non Commercial Share Alike 2.5", "CC-BY-NC-SA-2.5", false, false)
  val `CC-BY-NC-SA-3.0` =
    spdx("Creative Commons Attribution Non Commercial Share Alike 3.0", "CC-BY-NC-SA-3.0", false, false)
  val `CC-BY-NC-SA-4.0` =
    spdx("Creative Commons Attribution Non Commercial Share Alike 4.0", "CC-BY-NC-SA-4.0", false, false)
  ...
  val `CNRI-Python-GPL-Compatible` =
    spdx("CNRI Python Open Source GPL Compatible License Agreement", "CNRI-Python-GPL-Compatible", false, false)
  ...
  val `MPL-2.0-no-copyleft-exception` =
    spdx("Mozilla Public License 2.0 (no copyleft exception)", "MPL-2.0-no-copyleft-exception", true, false)
  ...
  val `Unicode-DFS-2015` =
    spdx("Unicode License Agreement - Data Files and Software (2015)", "Unicode-DFS-2015", false, false)
  val `Unicode-DFS-2016` =
    spdx("Unicode License Agreement - Data Files and Software (2016)", "Unicode-DFS-2016", false, false)
  ...
  val `GPL-2.0-with-autoconf-exception` =
    spdx("GNU General Public License v2.0 w/Autoconf exception", "GPL-2.0-with-autoconf-exception", false, false)
  val `GPL-2.0-with-bison-exception` =
    spdx("GNU General Public License v2.0 w/Bison exception", "GPL-2.0-with-bison-exception", false, false)
  val `GPL-2.0-with-classpath-exception` =
    spdx("GNU General Public License v2.0 w/Classpath exception", "GPL-2.0-with-classpath-exception", false, false)
  val `GPL-2.0-with-font-exception` =
    spdx("GNU General Public License v2.0 w/Font exception", "GPL-2.0-with-font-exception", false, false)
  val `GPL-2.0-with-GCC-exception` =
    spdx("GNU General Public License v2.0 w/GCC Runtime Library exception", "GPL-2.0-with-GCC-exception", false, false)
  ...
  val `GPL-3.0-with-autoconf-exception` =
    spdx("GNU General Public License v3.0 w/Autoconf exception", "GPL-3.0-with-autoconf-exception", false, false)
  val `GPL-3.0-with-GCC-exception` =
    spdx("GNU General Public License v3.0 w/GCC Runtime Library exception", "GPL-3.0-with-GCC-exception", true, false)
