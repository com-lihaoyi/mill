      ...
      adapter
        ...
        .getOrElse(throw new RuntimeException(
          """|Test framework class was not found. Please check that:
             |- the correct Scala.js dependency of the framework is used (like jvm"group::artifact::version", instead of jvm"group::artifact:version" for JVM Scala. Note the extra : before the version.)
