...
object FormatterStepConfig {
  ...
  sealed trait Generic extends FormatterStepConfig derives Reader
  ...
  object Generic {
    ...
    ) extends Generic derives Reader {
  ...
  sealed trait Java extends FormatterStepConfig derives Reader
  ...
  sealed trait Kotlin extends FormatterStepConfig derives Reader
