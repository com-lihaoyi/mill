  ...
  def deriveDepNames(): Unit = {
    ...
    def updateModule(module: ModuleSpec) = {
      ...
      module.copy(
        ...
        annotationProcessorsMvnDeps = updateMvnDeps(annotationProcessorsMvnDeps),
  ...
  def deriveBaseModule(baseTestHierarchy: (String, String)*): Unit = {
    ...
    def parentModule(a: ModuleSpec, b: ModuleSpec, name: String, hierarchy: Seq[String]) =
      ModuleSpec(
        ...
        pmdRulesets = parentValues(a.pmdRulesets, b.pmdRulesets),
        pmdVersion = parentValue(a.pmdVersion, b.pmdVersion),
    ...
    def extendModule(a: ModuleSpec, parent: ModuleSpec): ModuleSpec = a.copy(
      ...
      pmdRulesets = extendValues(a.pmdRulesets, parent.pmdRulesets),
      pmdVersion = extendValue(a.pmdVersion, parent.pmdVersion),
