      ...
      test("long") {
        assertGoldenLiteral(
          ...
          Set(
            ...
            "--remote-cache-read-timeout     <int> Timeout in seconds for each HTTP remote cache request (default 120).",
            ...
            "--remote-cache-connect-timeout  <int> Timeout in seconds for connecting to an HTTP remote cache (default 30).",
            ...
            "--watch                         Watch and re-run the given tasks when their inputs change.",
