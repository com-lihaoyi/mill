...
public class DebuggingOutputStream extends OutputStream {
  ...
  public DebuggingOutputStream(
      OutputStream out, Path workingDir, String name, boolean writeSeparateOps) {
    this.out = out;
  ...
  public void write(int b) throws IOException {
    if (writeSeparateOps)
      debugOutput.write((LocalDateTime.now() + " write(): " + b + "\n" /*+
  ...
  public void write(byte[] b, int off, int len) throws IOException {
    if (writeSeparateOps)
      debugOutput.write((LocalDateTime.now() + " write(off=" + off + ", len=" + len + "): "
