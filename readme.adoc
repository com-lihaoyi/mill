...
{link-github}/actions[image:{link-github}/workflows/ci-push-validation/badge.svg[Build Status]]
...
{link-milestone}/46?closed=1[milestone after 0.9.5]
...
and the {link-compare}/0.6.3\...master[list of commits]._
