...
[source,bash]
----
./mill dist.launcher && (cd example/scalalib/basic/1-simple && ../../../../out/dist/launcher.dest/run run --text hello)
----
...
[source,bash]
----
./mill dist.assembly && (cd example/scalalib/basic/1-simple && ../../../../out/dist/assembly.dest/mill run --text hello)
----
