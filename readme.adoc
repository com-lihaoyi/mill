...
* Added an {example/}[https://github.com/com-lihaoyi/mill/tree/main/example]
...
* Pre-compiled Scala incremental compiler interface
  {#2424}[https://github.com/com-lihaoyi/mill/pull/2424], to speed up clean builds
...
* You can now override `T{...}` `Target`s with `T.source` or `T.sources`, and
  vice versa {#2402}[https://github.com/com-lihaoyi/mill/pull/2402]

* Removed the Ammonite script runner dependency used to evaluate `build.sc`
  files and instead compile them using Mill {#2377}[https://github.com/com-lihaoyi/mill/pull/2377]

* Add `TestModule.ZioTest` {#2432}[https://github.com/com-lihaoyi/mill/pull/2432]

* Caching fixes for external modules {#2419}[https://github.com/com-lihaoyi/mill/issues/2419]
...
* Overhaul of the Mill `BuildInfo` plugin, moving the key-value into resources
  ...
  with the generated `BuildInfo` constants {#2425}[https://github.com/com-lihaoyi/mill/pull/2425]
