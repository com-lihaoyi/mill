...
* Support Scala Native 0.5.0-RC1  {link-pr}/3054[#3054]
* Update Scala Native to 0.5.0-RC3  {link-pr}/3107[#3107]
* Update Scala Native to 0.5.0  {link-pr}/3120[#3120]
...
* feat: adding sonatype central support  {link-pr}/3130[#3130] {link-pr}/3187[#3187]
