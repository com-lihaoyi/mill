...
object ScalaJSWebpackTests extends TestSuite {
  ...
  val mergedWithCustomWpConf: (String, String) => String = (outputPath, customConfigPath) =>
    s"""const merge = require('webpack-merge');
       ...
       |};
       |
       |module.exports = merge(generatedWebpackCfg, customWebpackCfg0);
       |""".stripMargin
    ...
    "webpack" - {
      ...
      "writeWithCustomCfg" - webpackTest(WebpackModuleTransitive) { ev =>
        ...
        result(
          ev.outPath,
          "webpack.config.js",
          Seq((os.resource / "customWpConfig.js"): ReadablePath),
          "out.js",
          "out-bundle.js",
          false
        )

        val cfg = read(ev.outPath / "webpack.config.js")
