...
protected[playlib] class RouteCompilerWorkerBase extends RouteCompilerWorkerApi {
  ...
  protected def compileWithPlay(files: Seq[os.Path],
  ...
  protected def compileWithPlay(file: os.Path,
                              additionalImports: Seq[String],
                              forwardsRouter: Boolean,
                              reverseRouter: Boolean,
                              namespaceReverseRouter: Boolean,
                              dest: os.Path,
                              routesGenerator: RoutesGenerator): Either[Seq[RoutesCompilationError], Seq[File]] = {
    val result =
