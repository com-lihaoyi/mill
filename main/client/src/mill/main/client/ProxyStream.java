...
//  * preserving ordering. This is useful for capturing stderr and stdout and
//  * forwarding them to a terminal while strictly preserving the ordering, i.e.
//  * users won't see exception stack traces and printlns arriving jumbled up and
//  * impossible to debug
//  *
//  * This works by converting writes from either of the two streams into packets
//  * of the form:
//  *
//  * 1 byte n bytes | header | body |
//  *
...
//  * abs(header) indicating the length of the packet body, in bytes - header == 0
...
//  * interleaving. On the other side, a `Pumper` reads from the combined stream,
//  * forwards each packet to its respective destination stream, or terminates when
//  * it hits a packet with `header == 0`
//  */
...
//                   System.out.println("ProxyStream.OUT");
// 									destOut.write(buffer, 0, offset);
// 									break;
// 								case ProxyStream.ERR:
//                   System.out.println("ProxyStream.ERR");
