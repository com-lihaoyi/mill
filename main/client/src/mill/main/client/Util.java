...
// public static void writeArgs(String[] args, OutputStream argStream) throws
// IOException {
...
// */
// public static void writeMap(Map<String, String> map, OutputStream argStream)
// throws IOException {
...
// public static Map<String, String> parseMap(InputStream argStream) throws
// IOException {
...
// *
// * @return The non-empty lines of the files or an empty list, if the file does
// not exist
// */
...
// /**
// * Interpolate variables in the form of <code>${VARIABLE}</code> based on the
// given Map <code>env</code>.
// * Missing vars will be replaced by the empty string.
// */
// public static String interpolateEnvVars(String input, Map<String, String>
// env) {
