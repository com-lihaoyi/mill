...
class IsolatedMillMainLoader {
    ...
    public static LoadResult load() {
        if (canLoad.isPresent()) {
            ...
            try {
                Class<?> millMainClass = IsolatedMillMainLoader.class.getClassLoader().loadClass("mill.entrypoint.MillMain");
    ...
    public static void runMain(String[] args) throws Exception {
        ...
        if (loadResult.millMainMethod.isPresent()) {
            ...
            throw new RuntimeException("Cannot load mill.entrypoint.MillMain class");
        }
    }
