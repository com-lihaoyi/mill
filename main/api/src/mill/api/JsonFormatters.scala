...
trait JsonFormatters {
  implicit val pathReadWrite: RW[os.Path] = upickle.default
    .readwriter[String]
    .bimap[os.Path](
      _.toString,
      os.Path(_)
  ...
  implicit val regexReadWrite: RW[Regex] = upickle.default
    .readwriter[String]
    .bimap[Regex](
      _.pattern.toString,
      _.r
  ...
  implicit val bytesReadWrite: RW[geny.Bytes] = upickle.default
    .readwriter[String]
    .bimap(
