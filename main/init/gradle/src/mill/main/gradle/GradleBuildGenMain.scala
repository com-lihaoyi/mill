        ...
        conf match {
          ...
          case COMPILE_ONLY_CONFIGURATION_NAME | COMPILE_ONLY_API_CONFIGURATION_NAME =>
            ...
            appendIvyDepPackage(
              ...
              onIvy = (v, id) => sd.copy(mainCompileMvnDeps = sd.mainCompileMvnDeps + v)
            )
          ...
          case RUNTIME_ONLY_CONFIGURATION_NAME =>
            appendIvyDepPackage(
              ...
              onIvy = (v, id) => sd.copy(mainRunMvnDeps = sd.mainRunMvnDeps + v)
            )
          ...
          case TEST_COMPILE_ONLY_CONFIGURATION_NAME =>
            appendIvyDepPackage(
              ...
              onIvy = (v, id) => sd.copy(testCompileMvnDeps = sd.testCompileMvnDeps + v)
            )
