...
* xref:readme.adoc#intellij_setup[IntelliJ Setup] - IntelliJ IDEA works great for Mill development; other IDEs may work as well
* xref:readme.adoc#pull_requests[Project Layout] - The source code repository structure from a high level view
