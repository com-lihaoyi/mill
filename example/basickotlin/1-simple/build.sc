...
import mill._, scalalib._, kotlinlib._

object foo extends RootModule with KotlinModule {
  def kotlinVersion = "1.0.0"
  def ivyDeps = Agg(
    ivy"org.jetbrains.kotlinx:kotlinx-cli-jvm:0.3.6",
    ivy"org.jetbrains.kotlinx:kotlinx-html-jvm:0.11.0",
  )

  object test extends KotlinTests with TestModule.Junit4{
    def ivyDeps = super.ivyDeps() ++ Agg(ivy"org.jetbrains.kotlinx:kotlin-test-junit:1.8.10")
  }
}
