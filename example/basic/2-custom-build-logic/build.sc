...
// `resources` (also an existing target). `os.read.lines` comes from the
// https://github.com/com-lihaoyi/os-lib[OS-Lib] library, which is bundled with
// Mill. This generated file can then be
