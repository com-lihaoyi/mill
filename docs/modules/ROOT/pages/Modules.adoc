...
include::example/depth/modules/7-modules.adoc[]

== Use Case: DIY Java Modules

include::example/depth/modules/8-diy-java-modules.adoc[]

== Backticked Names

include::example/depth/modules/9-backticked-names.adoc[]
