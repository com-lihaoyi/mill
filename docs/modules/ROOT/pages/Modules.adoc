...
include::example/depth/tasks/7-modules.adoc[]

== Use Case: DIY Java Modules

include::example/depth/tasks/8-diy-java-modules.adoc[]

== Backticked Names

include::example/depth/tasks/9-backticked-names.adoc[]
...
include::example/depth/tasks/10-module-sc.adoc[]
