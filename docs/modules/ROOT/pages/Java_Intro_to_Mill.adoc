...
https://github.com/swaldman/c3p0/blob/0.10.x/build.sc[C3P0 JDBC Connection Pool].
...
xref:Java_Web_Build_Examples.html#_spring_boot_todomvc_app[Spring Boot] or
xref:Java_Web_Build_Examples.html#_micronaut_todomvc_app[Micronaut].
