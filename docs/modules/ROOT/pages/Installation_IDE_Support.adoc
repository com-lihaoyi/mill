...
[#_bootstrap_scripts]
== Bootstrap Scripts: `mill` or `millw`
...
Please keep in mind, that all those solutions listed below are maintained outside of Mill and may not have the same features as the <<_bootstrap_scripts>>.
