...
:page-aliases: Java_Intro_to_Mill.adoc
...
xref:javalib/Java_Web_Examples.adoc#_spring_boot_todomvc_app[Spring Boot] or
xref:javalib/Java_Web_Examples.adoc#_micronaut_todomvc_app[Micronaut].
