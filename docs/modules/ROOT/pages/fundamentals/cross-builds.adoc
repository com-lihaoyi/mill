...
include::partial$example/depth/cross/1-simple.adoc[]

== Default Cross Modules

include::partial$example/depth/cross/11-default-cross-module.adoc[]
...
include::partial$example/depth/cross/4-cross-dependencies.adoc[]

== Multiple Cross Axes

include::partial$example/depth/cross/5-multiple-cross-axes.adoc[]

== Extending Cross Modules

include::partial$example/depth/cross/6-axes-extension.adoc[]

== Inner Cross Modules

include::partial$example/depth/cross/7-inner-cross-module.adoc[]

== Cross Resolvers

include::partial$example/depth/cross/8-resolvers.adoc[]

== Dynamic Cross Modules

include::partial$example/depth/cross/9-dynamic-cross-modules.adoc[]

== Use Case: Static Blog

include::partial$example/depth/cross/10-static-blog.adoc[]
