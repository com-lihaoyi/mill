...
include::partial$example/scalalib/module/3-override-tasks.adoc[]
...
include::partial$example/scalalib/module/5-ivy-deps.adoc[]

== Runtime and Compile-time Dependencies

include::partial$example/scalalib/module/6-run-compile-deps.adoc[]
...
include::partial$example/scalalib/module/10-unmanaged-jars.adoc[]
...
include::partial$example/scalalib/module/12-downloading-non-maven-jars.adoc[]

== Customizing the Assembly

include::partial$example/scalalib/module/13-assembly-config.adoc[]

== Repository Config

include::partial$example/scalalib/module/14-repository-config.adoc[]
