...
1. *Compilation*: done on-demand and incrementally using the Scala
...
2. *Planning*: if the `RootModule` was re-used, then all
...
Everything earlier in the doc - <<_the_mill_evaluation_model>>,
