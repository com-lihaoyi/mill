...
include::example/scalalib/module/1-common-config.adoc[]

== Custom Tasks

include::example/scalalib/module/2-custom-tasks.adoc[]

== Overriding Tasks

include::example/scalalib/module/3-override-tasks.adoc[]


== Compilation & Execution Flags

include::example/scalalib/module/4-compilation-execution-flags.adoc[]

== Adding Ivy Dependencies

include::example/scalalib/module/5-ivy-deps.adoc[]

== Runtime and Compile-time Dependencies

include::example/scalalib/module/6-run-compile-deps.adoc[]

== Classpath and Filesystem Resources

include::example/scalalib/module/7-resources.adoc[]

== Scala Compiler Plugins

include::example/scalalib/module/8-scala-compiler-plugins.adoc[]

== Scaladoc Config

include::example/scalalib/module/9-docjar.adoc[]

== Unmanaged Jars

include::example/scalalib/module/10-unmanaged-jars.adoc[]

== Specifying the Main Class

include::example/scalalib/module/11-main-class.adoc[]

== Downloading Non-Maven Jars

include::example/scalalib/module/12-downloading-non-maven-jars.adoc[]

== Customizing the Assembly

include::example/scalalib/module/13-assembly-config.adoc[]

== Repository Config

include::example/scalalib/module/14-repository-config.adoc[]
...
include::example/scalalib/module/15-unidoc.adoc[]
