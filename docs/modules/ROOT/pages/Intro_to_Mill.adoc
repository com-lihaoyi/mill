...
include::example/basic/1-simple-java.adoc[]

== Simple Scala Module

include::example/basic/2-simple-scala.adoc[]

== Custom Build Logic

include::example/basic/3-custom-build-logic.adoc[]

== Multi-Module Project

include::example/basic/4-multi-module.adoc[]
