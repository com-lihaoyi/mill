...
usage: mill [options] [[target [target-options]] [+ [target ...]]]
  ...
  --onlydeps                        Experimental: Evaluate only the dependencies of the given
                                    targets. If you specify multiple targets or a pattern, ensure
                                    they don't depend on each other, otherwise evaluation will fail.
