...
makes the semantics of Mill builds feel familiar even for first time users.
...
[cols="1a,1a,1a"]
|===
| * xref:comparisons/why-mill.adoc[] | * xref:cli/installation-ide.adoc[] | * xref:migrating/migrating.adoc[]
|===
