...
* https://www.youtube.com/watch?v=xbGG7MDWR-M[Video: Better Scala Builds with the Mill Build Tool],
  Scala.IO Paris Conference Nov 2024
...
For commercial support and services related to Mill, email info@mill-build.org
