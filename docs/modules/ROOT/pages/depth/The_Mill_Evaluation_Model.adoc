...
xref:scalalib/Scala_Builtin_Commands.adoc#inspect[inspect], xref:scalalib/Scala_Builtin_Commands.adoc#plan[plan],
xref:scalalib/Scala_Builtin_Commands.adoc#_visualize[visualize], etc.. This helps keep your
...
xref:extending/The_Mill_Meta_Build.adoc[The Mill Meta Build] works through a simple use case
