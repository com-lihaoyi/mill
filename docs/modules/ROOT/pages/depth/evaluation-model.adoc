...
xref:fundamentals/builtin-commands.adoc#_inspect[inspect], xref:fundamentals/builtin-commands.adoc#_plan[plan],
xref:fundamentals/builtin-commands.adoc#_visualize[visualize], etc.. This helps keep your
