...
include::partial$example/depth/tasks/1-task-graph.adoc[]

[#primitive-tasks]
== Primary Tasks

include::partial$example/depth/tasks/2-primary-tasks.adoc[]

== Other Tasks

=== Anonymous Tasks

include::partial$example/depth/tasks/3-anonymous-tasks.adoc[]
...
include::partial$example/depth/tasks/6-workers.adoc[]


== Using ScalaModule.run as a task

include::partial$example/depth/tasks/11-module-run-task.adoc[]

== (Experimental) Forking Concurrent Futures within Tasks

include::partial$example/depth/tasks/7-forking-futures.adoc[]
