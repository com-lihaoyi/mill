...
include::partial$example/depth/libraries/1-oslib.adoc[]
...
include::partial$example/depth/libraries/2-upickle.adoc[]
...
include::partial$example/depth/libraries/3-requests.adoc[]
...
include::partial$example/depth/libraries/4-mainargs.adoc[]
