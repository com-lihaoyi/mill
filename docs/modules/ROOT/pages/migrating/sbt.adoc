...
include::partial$example/scalalib/migrating/1-sbt-complete.adoc[]

Projects with a complex build often require some manual tweaking in order to work:

include::partial$example/scalalib/migrating/2-sbt-incomplete.adoc[]
...
`java.lang.UnsupportedOperationException: The Security Manager is deprecated and will be removed in a future release` and
