...
* {mill-doc-url}/api/latest/mill/scalalib/MavenModule.html[`mill.kotlinlib.MavenModule`]
* {mill-doc-url}/api/latest/mill/kotlinlib/kotlinlib.html[`mill.kotlinlib.KotlinLib`]

== Common Configuration Overrides

include::example/kotlinlib/builds/1-common-config.adoc[]

== Custom Tasks

include::example/kotlinlib/builds/2-custom-tasks.adoc[]

== Overriding Tasks

include::example/kotlinlib/builds/3-override-tasks.adoc[]

== Nesting Modules

include::example/kotlinlib/builds/4-nested-modules.adoc[]

== Maven-Compatible Modules

include::example/kotlinlib/builds/8-compat-modules.adoc[]


== Realistic Kotlin Example Project

include::example/kotlinlib/builds/9-realistic.adoc[]
