...
If you wish to use bloop as your build server (it is the default metals BSP implementation) with metals / vscode, you may also consider following the instructions here; 
https://scalacenter.github.io/bloop/docs/build-tools/mill[Bloop and Mill]. The summary of which is add this to your build.sc
----
...
----
in the terminal. Restarting the build server should then import the build.
