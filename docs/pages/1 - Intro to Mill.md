...
https://github.com/lihaoyi/mill/releases/download/0.5.7/0.5.7-assembly, and save
it as `mill.bat`.
...
```bash
sudo curl -L https://github.com/lihaoyi/mill/releases/download/0.5.7/0.5.7 > /usr/local/bin/mill && sudo chmod +x /usr/local/bin/mill
```
...
```bash
curl -L https://github.com/lihaoyi/mill/releases/download/0.5.7/0.5.7 > mill && chmod +x mill
```
