...
After that, you can follow the instructions in <<adding-a-test-suite,add a test suite>>, and use `mill foo.test` as usual, or pass args to the test suite via `mill foo.test arg1 arg2 arg3`.
