...
* `ScalaModule` / `JvmWorkerModule`: Fixed incremental compilation issue with JRE 17 (and probably others)
...
* Fixed Log4Shell security vulnerability in `JvmWorkerModule` (CVE-2021-44228)
