...
`1.1.0` is a locally-breaking change but preserves plugin compatibility: you may need to update
...
`.mill` module definitions, and is intended for simple projects or modules that do not
...
See the docs for https://mill-build.org/mill/main-branch/javalib/config.html[Config-Based Java Modules]
for more information

==== Single-File Script Modules
