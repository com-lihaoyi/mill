...
from projects on Mill 0.12.x or earlier to migrate to 1.0.0-RC1, any Mill plugins will need to be
re-published for Mill-1.0.0-RC1, and there may be issues in the release candidate that we hope to
surface and fix.
