...
* Improvements to GraalVM Native Image support {link-pr}/6315[#6315] {link-pr}/6547[#6547]
...
for https://mill-build.org/mill/main-branch/javalib/config.html[Declarative Java Modules]
