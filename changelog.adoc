...
files and single-file scripts with a YAML build header. These are compatible with existing
`.mill` module definitions, and are intended for simple projects or modules that do not
need the flexibility of a full programming language to configure their build.
