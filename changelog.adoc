...
This section aggregates the changes from `1.1.0-RC1` to `1.1.0-RC4`, which are no longer
documented individually now that the final `1.1.0` release is out.
...
* Improvements to `./mill init` {link-pr}/6566[#6566] {link-pr}/6567[#6567] {link-pr}/6434[#6434] {link-pr}/5428[#5428]
