...
* Break the dependency between repositoriesTask and ivyDeps (#4472)
* Update coursier to 2.1.25-M2 (adds early Gradle Module support) - 0.12.x (#4623)
* Fix semanticdbData for mixed scala/java projects (#4599) (#4629)
* Improve performances of Bloop/install (#4600) (#4628)
* Pass Mill source JARs to Bloop (#4608)
* Optimize BSP initialization stuff (#4698)
