  ...
  def tests = Tests {
    ...
    val versions = List[VersionPaths](
      ...
      VersionPaths(
        ...
        s"$home\\.mill\\download\\0.12.6.bat"
      ),
      ...
      VersionPaths(
        ...
        s"$home\\.mill\\download\\0.12.11-native.exe"
      ),
      VersionPaths(
        "0.12.11-jvm",
        "https://repo1.maven.org/maven2/com/lihaoyi/mill-dist/0.12.11/mill-dist-0.12.11.jar",
      ...
      VersionPaths(
        ...
        s"$home\\.mill\\download\\0.12.12.bat"
      ),
      VersionPaths(
        "0.12.12-native",
        ...
        s"$home\\.mill\\download\\0.12.12-native.exe"
      ),
      ...
      VersionPaths(
        ...
        s"$home\\.mill\\download\\1.0.0-M1.exe"
      ),
      VersionPaths(
        "1.0.0-M1-native",
        s"https://repo1.maven.org/maven2/com/lihaoyi/mill-dist-native-$nativeSuffix/1.0.0-M1/mill-dist-native-$nativeSuffix-1.0.0-M1.exe",
        s"$home/.cache/mill/download/1.0.0-M1-native-$nativeSuffix",
        s"$home\\.mill\\download\\1.0.0-M1-native.exe"
      ),
      VersionPaths(
        "1.0.0-M1-jvm",
